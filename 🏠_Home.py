...
def feedback_dialog(message, icon):
    ...
    user_feedback = st.text_area("Your Thoughts", placeholder="Tell us what you liked or what we can improve...")
...
if selected is not None and "feedback_submitted" not in st.session_state:
    if selected >= 3:
        message = "🌟 Thanks for the amazing rating! We’re thrilled you love Footverse! 🔥"
        icon = "🥳"
    elif selected == 2:
