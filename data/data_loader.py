...
def store_session_data():
    ...
    if outfield_df:
        ...
        if "outfield_data" not in st.session_state:
            st.session_state.outfield_data = outfield_data

    if goalkeeping_df:
        goalkeeping_data = merge_data(*goalkeeping_df)
        if "goalkeeping_data" not in st.session_state:
            st.session_state.goalkeeping_data = goalkeeping_data
